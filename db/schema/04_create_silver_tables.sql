-- =============================================================
-- RadarPépites - Tables de faits silver
-- Fichier  : 04_create_silver_tables.sql
-- Exécuter : après 03_insert_silver_referentiels.sql
-- =============================================================


-- -------------------------------------------------------------
-- silver.players_info (dimension joueurs)
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- silver.players_fbref (faits fbref Big 5)
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- silver.players_sofascore (faits Sofascore 10 ligues)
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- silver.players_combined (table principale joueurs de champ)
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- silver.keepers_combined (table principale gardiens)
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- Index performance Silver
-- -------------------------------------------------------------
CREATE INDEX IF NOT EXISTS idx_pc_ligue    ON silver.players_combined(ligue_id);
CREATE INDEX IF NOT EXISTS idx_pc_saison   ON silver.players_combined(saison_id);
CREATE INDEX IF NOT EXISTS idx_pc_u23      ON silver.players_combined(is_u23);
CREATE INDEX IF NOT EXISTS idx_pc_poste    ON silver.players_combined(poste_principal);
CREATE INDEX IF NOT EXISTS idx_pc_player   ON silver.players_combined(player_id_ss);
CREATE INDEX IF NOT EXISTS idx_kc_ligue    ON silver.keepers_combined(ligue_id);
CREATE INDEX IF NOT EXISTS idx_kc_u23      ON silver.keepers_combined(is_u23);
